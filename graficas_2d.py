...
linea_5 =c.create_line(BASE/2,ALTURA/2,BASE,ALTURA/2,fill="brown", width=2)
linea_6 =c.create_line(BASE/2,ALTURA/2,BASE/2,0,fill="pink", width=2)
linea_7 =c.create_line(BASE/2,ALTURA/2,BASE/2,ALTURA,fill="white", width=2)
linea_8 =c.create_line(BASE/2,ALTURA/2,0,ALTURA/2,fill="orange", width=2)
...
rect_2 =c.create_rectangle(0,0,BASE/2,ALTURA/2, fill="pink", outline="white")
